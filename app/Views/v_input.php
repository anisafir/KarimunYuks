            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <?php if (auth()->loggedIn()) : ?>
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="#"><i class="fa-solid fa-circle-plus">
                                </i> Input</a>
                        </li>
                        <li class="nav-item">
    ...
    <div class="container my-3">
        ...
        <div class="card">
            <div class="card-header">
                <h2><i class="fa-solid fa-circle-plus"></i> Input Data Lokasi Objek</h2>
            </div>
            <div class="card-body">
                <form action="<?= base_url('home/simpan_tambah_data') ?>" method="POST" enctype="multipart/form-data">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="nama" name="nama" placeholder="Isikan nama objek ">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="latitude" name="latitude" placeholder="Isikan latitude">
                    </div>
                    <div class="mb-3">
                        <label for="longitude" class="form-label"> <i class="fa-solid fa-location-dot"></i> Longitude</label>
                        <input type="text" class="form-control" id="longitude" name="longitude" placeholder="Isikan longitude">
                    </div>
                    <div class="mb-3">

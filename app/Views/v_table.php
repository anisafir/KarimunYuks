        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <?php if (auth()->loggedIn()) : ?>
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="<?= base_url('home/input') ?>"><i class="fa-solid fa-circle-plus">
                                </i> Input</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" href="#"><i class="fa-solid fa-table"></i> Tabel</a>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-danger" href="<?= base_url('logout') ?>"><i class="fa-solid fa-right-from-bracket">
                                </i> Logout</a>
                        </li>
                    <?php else : ?>
                        <li class="nav-item">
    ...
    <div class="container my-3">
        ...
        <div class="card">
            <div class="card-header">
                <h2><i class="fa-solid fa-circle-plus"></i> Tabel Data Lokasi Objek</h2>
            </div>
            <div class="card-body">
                <table class="table table-striped table-bordered" id="dataobjek">
                    <thead>
                        <tr>
                            <th>No</th>
                            <th>Nama</th>
                        ...
                        foreach ($dataobjek as $d) : ?>
                            <tr>
                                ...
                                <td class="d-flex justify-content-center">
                                    <a class="btn btn-warning" href="<?= base_url('home/edit_data/') . $d['id'] ?>" role="button">
                                    <i class="fa-solid fa-pen-to-square"></i></a>
                                    <a class="btn btn-danger" href="<?= base_url('home/hapus_data/') . $d['id'] ?>" role="button" 
                                    onclick="return confirm('Yakin akan menghapus data <?= $d['nama'] ?> ini?')" ><i class="fa-solid fa-trash"></i></a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </body>
